...
# Duration of p1 in days
    p2_length <- params$period[2] - params$period[1]
    p2_length <- as.double(p2_length)
    
    # End date of comparison period (p2)
    p2_end <- params$period[1]
    p2_end <- p2_end - 1
...
- Počet vážně zraněných v dopravních nehodách `r format_integer(swound_p1)`, změna `r change_fce(swound_p1,swound_p2)` oproti srovnávacímu období
