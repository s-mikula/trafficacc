...
if(nrow(params$data_accidents) <= 100){

accidents_buffer <- params$data_accidents %>% 
  st_convex_hull() %>% 
  st_buffer(100)

bg_map <- read_osm(accidents_buffer)
...
tm_shape(bg_map) +
  ...
  print("Ve výběru je příliš mnoho nehod pro vykreslení mapy.")
}
